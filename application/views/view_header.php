				...
				<div class="col-md-9 col-sm-12 main-menu" style="display: block;">
					<div class="main-menu-item">				 	
				 		<ul class="nav-menu" style="color:#fff;">
							...
							<li  ><a href="<?php echo base_url(); ?>" style="color:#fff !important;"><?php echo HOME; ?></a></li>
							<?php endif; ?>
							
							<?php if($menu_data['about_status'] == 1): ?>
							<li  ><a href="<?php echo base_url(); ?>about" style="color:#fff !important;"><?php echo ABOUT; ?></a></li>
							<?php endif; ?>
							
							<?php if($menu_data['gallery_status'] == 1): ?>
									<li><a href="<?php echo base_url(); ?>gallery" style="color:#fff !important;"><?php echo GALLERY; ?></a></li>
							<?php endif; ?>


							<?php if($menu_data['service_status'] == 1): ?>
							<li><a href="<?php echo base_url(); ?>service" style="color:#fff !important;"><?php echo SERVICE; ?></a></li>
							<?php endif; ?>

							<?php if($menu_data['portfolio_status'] == 1): ?>
							<li><a href="<?php echo base_url(); ?>portfolio" style="color:#fff !important;"><?php echo PORTFOLIO; ?></a></li>
							<?php endif; ?>

							<?php if($menu_data['testimonial_status'] == 1): ?>
							<li><a href="<?php echo base_url(); ?>testimonial" style="color:#fff !important;"><?php echo TESTIMONIAL; ?></a></li>
							<?php endif; ?>

							<?php if($menu_data['news_status'] == 1): ?>
							<li><a href="<?php echo base_url(); ?>news/page" style="color:#fff !important;"><?php echo NEWS; ?></a></li>
							<?php endif; ?>

							<?php if($menu_data['contact_status'] == 1): ?>
							<li><a href="<?php echo base_url(); ?>contact" style="color:#fff !important;"><?php echo CONTACT; ?></a></li>
							<?php endif; ?>
